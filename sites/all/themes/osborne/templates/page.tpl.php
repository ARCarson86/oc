...
?>
 ...
 <div id="page-wrapper"><div id="page">
  ...
  <?php print render($page['header']); ?>
      ...
      <?php if ($logo): ?>
        <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home" id="logo" class="col-md-offset-1 col-md-4">
    ...
    <div id="main-wrapper" class="container"><div class="row">
      ...
      <?php if ($page['sidebar']): ?>
        <div id="sidebar" class="col-md-offset-1 col-md-3 col-sm-12">
          <?php print render($page['sidebar']); ?>
        </div> <!-- /.section, /#sidebar-first -->
      <?php endif; ?>

      <div id="content" class="col-md-offset-1 col-md-7 col-sm-12"><div class="section">
        <a id="main-content"></a>
